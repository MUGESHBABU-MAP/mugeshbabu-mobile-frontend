              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _buildContactItem(Icons.phone, 'Phone', '+91 8072888085'),
                    const SizedBox(height: 8),
                    _buildContactItem(Icons.email, 'Email', 'mugeshbabu.in@gamil.com'),
                    const SizedBox(height: 8),
                    _buildContactItem(Icons.access_time, 'Hours', '8/6 Support Available'),
                  ],
                ),
              ),
            ),
